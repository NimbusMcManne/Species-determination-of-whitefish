...
class Config:
    ...
    # --- Dataset Settings ---
    # config.py
    DATASET_PATH: str = "D:\\programms\\ML\\organised_dataset\\"
    PLOTS_DIR: str = "D:\\programms\\ML\\Species-determination-of-whitefish\\efficientnetb1_implementation\\working\\plots"
    DISPLAY_PLOTS: bool = True  # Recommendation: keep True for testing, False for production
    NUM_CLASSES: int = 2
    ...
    CHECKPOINT_DIR = "D:\\programms\\ML\\Species-determination-of-whitefish\\efficientnetb1_implementation\\working\\checkpoints"
    ...
    def validate() -> None:
        ...
        Ensures that parameters are positive or non-negative.
