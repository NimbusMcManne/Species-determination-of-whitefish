...
def load_fish_dataset(type) -> Tuple[List[str], List[str], List[str]]:
    """Loads the fish dataset, returning image paths, labels, and classes.
    ...
    """
    if type == 'train':
        dataset_path = Config.DATASET_PATH + "train\\"
    elif type == 'test':
        dataset_path = Config.DATASET_PATH + "test\\"
